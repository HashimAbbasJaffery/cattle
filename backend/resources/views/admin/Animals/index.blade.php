            ...
            <div class="card">
                <div class="card-body">
                    <div style="display: flex; justify-content: space-between;">
                        ...
                        <a href="{{ route('user.create') }}" style="text-decoration: none;" class="btn-info btn-sm" >Create New Animal</a>
                    </div>
                    ...
                    <tbody>
                        <tr v-for="animal in animals" :key="animal.id">
                            ...
                            <td>
                                <a :href="" class="btn btn-primary btn-sm" style="margin-right: 10px;">Update</a>
