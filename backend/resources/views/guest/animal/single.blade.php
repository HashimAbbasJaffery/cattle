    ...
    <header class="bg-primary website-header rounded-b-xl">
        <div class="container flex items-center">
            <div class="logo-container flex items-center" style="padding-bottom: 5px;">
                <img src="./assets/images/new_logo.png" style="width: 30px;" class="logo mr-2"> 
            ...
            <div class="left-container w-1/2" style="background-color: #eae5df;  border-bottom-right-radius: 15px;">
                <div class="cow-image">
                    <swiper-container navigation="true" pagination="true" loop="true" style=" --swiper-navigation-size: 20px">
                        ...
                        <swiper-slide>
                            <img src="./assets/images/cow2.jpg">
                        </swiper-slide>
                        <swiper-slide>
                            <img src="./assets/images/cow3.jpg">
                        </swiper-slide>
                    </swiper-container>
                    ...
                    <div class="mobile-containers relative" style="padding-left: 20px;">
                        <div class="mobile-left-container">
                            <h1 style="margin-top: 15px; font-weight: 600; font-size: 5.7vw;">Rani</h1>
                            <p class="mobile-price" style="font-weight: 600;">PKR 1,000,000/-</p>
                            <div class="live-weight flex items-center">
                                <p class="mr-5" style="font-size: 13px;">420kg live weight</p>
                                <div class="flex items-center">
                                    <i class="pr-1 fa fa-circle text-danger-glow blink mr-4" style="font-size: 10px;margin-right: 0px;"></i>
                                    <img src="./assets/images/weight.png" class="ml-1" style="width: 15px;" />
                                </div>
                            </div>
                        </div>
                ...
                <div class="cow-images flex gap-2 px-3 mt-3">
                    <div class="cow-image rounded-md" style="width: 50px; height: 50px; background-image: url('./assets/images/cow.jpg'); background-size: cover; background-position: -15px 0px;"></div>
                    <div class="cow-image rounded-md" style="width: 50px; height: 50px; background-image: url('./assets/images/cow.jpg'); background-size: cover; background-position: -15px 0px;"></div>
                    <div class="cow-image rounded-md" style="width: 50px; height: 50px; background-image: url('./assets/images/cow.jpg'); background-size: cover; background-position: -15px 0px;"></div>
                 </div>
                    ...
                    <div class="facility-list flex" style="width: 80%;">
                        <div class="facilities space-y-3 mr-4">
                            <div class="flex justify-between items-center gap-3">
                                <p>Premium VG Feed</p>
                                <img class="ml-3" src="./assets/images/food.png" width="25">
                            </div>
                            <div class="flex justify-between items-center">
                                <p>Professional staff</p>
                                <img class="ml-3" src="./assets/images/buesinessman.png" width="25">
                            </div>
                            <div class="flex justify-between items-center">
                                <p>Clean environment</p>
                                <img class="ml-3" src="./assets/images/clean.png" width="23">
                            </div>
                        </div>
                        ...
                        <div class="facilities space-y-3 ml-4">
                            <div class="flex justify-between items-center">
                                ...
                                <img src="./assets/images/ambulance.png" class="mr-3" width="25">
                            </div>
                            <div class="flex justify-between items-center">
                                <p class="order-1">Complete Vaccination</p>
                                <img src="./assets/images/vaccination.png" class="mr-3" width="25">
                            </div>
                            <div class="flex justify-between items-center">
                                <p class="order-1">Clean water</p>
                                <img src="./assets/images/droplet.png" class="mr-3" width="25">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="facilitations-and-description bg-cream flex items-start" style="padding-left: 20px;">
                    <div class="descriptions" style="width: 50%;">
                        <div class="description-header" style="padding-bottom: 0px;">
                            <div class="flex justify-between">
                                ...
                                <p style="font-size: 2.5vw !important;">Brahmand</p>
                            </div>
                            <div class="flex justify-between">
                                <p style="font-size: 2.5vw !important;">Gender</p>
                                <p style="font-size: 2.5vw !important;">Female</p>
                            </div>
                            <div class="flex justify-between">
                                <p style="font-size: 2.5vw !important;">Age</p>
                                <p style="font-size: 2.5vw !important;">3 Teeth</p>
                            </div>
                        </div>
                    ...
                    <div class="mobile-facilitations" style="width: 50%; border-bottom-left-radius: 5px;">
                        ...
                        <div class="facility-list" style="padding-right: 15px;">
                            <div class="flex justify-between items-center">
                                <p>Premium VG feed</p> 
                                <img style="width: 15px;" src="./assets/images/food.png">
                            </div>
                            <div class="flex justify-between items-center">
                                <p>24/7 Veterinary Doctor</p> 
                                <img style="width: 15px;" src="./assets/images/ambulance.png">
                            </div>
                            <div class="flex justify-between items-center">
                                <p>Professional Staff</p> 
                                <img style="width: 15px;" src="./assets/images/buesinessman.png">
                            </div>
                            <div class="flex justify-between items-center">
                                <p>Complete Vaccination</p> 
                                <img style="width: 15px;" src="./assets/images/vaccination.png">
                            </div>
                            <div class="flex justify-between items-center">
                                <p>Clean Environment</p> 
                                <img style="width: 15px;" src="./assets/images/clean.png">
                            </div>
                            <div class="flex justify-between items-center">
                                <p>Clean Water</p> 
                                <img style="width: 15px;" src="./assets/images/droplet.png">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="right-container w-1/2">
                ...
                <p class="weight flex items-center pl-4">
                    ...
                    <span class="icons flex items-center">
                        ...
                        <img src="./assets/images/weight.png" style="width: 35px; height: 35px;" />
                    </span>
                </p>
                ...
                <swiper-slide style="width: 100%; margin-top: 10px !important;">
                    <div class="animal flex grid mr-3" style="background-color: #ebe7e1; border-radius: 10px; margin-bottom: 10px; width: 95%;">
                        ...
                        <div class="animal-info" style="width: 60%; line-height: 27px;">
                            <h1 class="" style="margin-bottom: 0px; margin-top: 3px; text-transform: uppercase; font-size: 18px !important;">Badal</h1>
                            <p class="font-medium px-3">PKR 1,000,000/-</p>
                            <p class="px-3" style="font-size: 14px !important">420 KG (Live Weight)</p>
                    ...
                    <div class="animal flex grid mr-3" style="background-color: #ebe7e1; border-radius: 10px; margin-bottom: 10px; width: 95%;">
                        <div class="animal-image justify-end relative" >
                            <swiper-container class="test" class="text-red-400 bg-sold/40" style="background-blend-mode: darken; border-top-left-radius: 10px; --swiper-navigation-size: 20px">
                                <swiper-slide>
                                    <img src="./assets/images/cow4.jpg" />
                                </swiper-slide>
                                <swiper-slide>
                                    <img src="./assets/images/cow4.jpg" />
                               </swiper-slide>
                        ...
                        <div class="animal-info" style="width: 60%; line-height: 27px;">
                            <h1 class="" style="height: 3.5vw !important; margin-bottom: 0px; margin-top: 0px; text-transform: uppercase; font-size: 3vw !important; font-weight: 600; margin-bottom: 0px !important; padding-bottom: 0px !important; height: 16px;">Prince</h1>
                            <p class="font-medium px-3;" style="height: 3.5vw !important; font-size: 3vw;">PKR 1,000,000/-</p>
                            <p class="px-3" style="font-size: 2.7vw !important; height: 3.5vw !important;">420 KG (Live Weight)</p>
                            <div class="categories flex justify-center gap-3 mt-8 items-center" style="padding-top: 0px;">
                                <div class="breed category">
                                    <p class="mobile-slide-category" style="font-size: 2vw !important;">Cholistani</p>
                                </div>
                                <div class="divider" style="width: 0.5px; background-color: #aaa7a2; height: 16px;">&nbsp;</div>
                                <div class="gender category">
                                    <p class="mobile-slide-category" style="font-size: 2vw !important;">Female</p>
                                </div>
                                <div class="divider" style="width: 0.5px; background-color: #aaa7a2; height: 16px;">&nbsp;</div>
                                <div class="age category pr-3">
                                    <p class="mobile-slide-category" style="font-size: 2vw !important;">3 Teeth</p>
                                </div>
                            </div>
                            <div class="animal-footer pl-3 installment flex gap-3 items-start mt-2">
                                <i class="fa-solid fa-calendar-days" style="font-size: 19px;"></i>
 ...
 <swiper-slide style="width: 100%; margin-top: 10px !important;">
        ...
        <section id="buttons" class="container mx-auto z-1" style="background: white; padding-top: 10px; padding-bottom: 10px;">
            <div class="purchase flex mb-3 gap-2">
                <button class="bg-green w-1/2 p-2 rounded-full" style="color: white;">Cash</button>
                <button class="bg-green w-1/2 rounded-full" style="color: white;">Installment</button>
            </div>
            <div class="contact">
